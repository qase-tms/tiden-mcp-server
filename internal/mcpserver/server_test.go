...
func TestInputSchemaUnmarshal(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: `{"product_id":"prod-123","requirement_id":"draft-1","intent_branch":"intent/x","session_id":"3f0e8c1a-2b4d-4e6f-8a9b-0c1d2e3f4a5b","acceptances":[{"requirement_ids":["req-1"],"criterion":"R4","evidence":"provider sandbox covers the contract","follow_up":"issue:QA-42"}]}`,
		},
		{
			tool:  "list_test_runs",
